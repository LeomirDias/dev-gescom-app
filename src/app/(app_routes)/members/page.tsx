...
export default function MembersPage() {
  ...
  const applyFiltersFromForm = useCallback(() => {
    const form = document.getElementById("members-filters-form")
  ...
  const clearFilters = useCallback(() => {
    const reset = defaultMembersListFilters()
  ...
  return (
    <main className="mx-auto flex w-full flex-col gap-6 p-4 md:p-8">
      {isPending && <MembersContentLoading />}
