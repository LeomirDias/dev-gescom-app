...
export function ClientsRouteLoading() {
  return (
    <main
    ...
    >
      <ListContentLoading label="A carregar clientes" />
    </main>
  )
}

export function ClientsContentLoading() {
  return <ListContentLoading label="A carregar lista de clientes" />
}

export function ClientDetailContentLoading() {
  return <DetailContentLoading label="A carregar detalhe do cliente" />
}
...
export function ClientFormContentLoading() {
  return <FormContentLoading label="A carregar formulário de cliente" />
}
