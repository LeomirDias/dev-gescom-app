...
import { passwordResetVerifyService } from "@/modules/authentication/password-reset.service"
...
export function PasswordResetVerifyForm({
  ...
  const verifyMutation = useMutation({
    mutationFn: passwordResetVerifyService,
  })
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-balance text-muted-foreground">
                  Informe o codigo recebido e crie uma nova senha
                </p>
              </div>
              <Field>
